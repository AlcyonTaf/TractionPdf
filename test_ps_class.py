# exmple provient de https://stackoverflow.com/questions/67920470/tkinter-read-subprocess-output-and-put-it-into-the-gui
...
class ShowProcessOutputDemo:
    ...
    def show_stdout(self):
        ...
        self.label.insert('end', self.stdout_data.strip("\n"))
